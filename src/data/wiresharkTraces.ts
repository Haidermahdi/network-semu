  ...
  'ospf-hello': [
    {
      ...
      layers: [
        ...
        },
        {
          ...
          fields: [
            { key: 'Destination', value: '01:00:5e:00:00:05 (IPv4 Multicast AllSPFRouters)', annotationAr: 'عنوان ماك خاص بالبث المتعدد لراوترات OSPF', annotationEn: 'Multicast MAC reserved for All-OSPF-Routers' },
            { key: 'Source', value: '50:00:00:01:00:01 (Cisco Router 1 Gi0/0/0)', annotationAr: 'عنوان الماك الفيزيائي لمنفذ الراوتر المرسل', annotationEn: 'Physical MAC address of sending router egress port' },
            { key: 'Type', value: 'IPv4 (0x0800)', annotationAr: 'نوع البروتوكول في Layer 3 هو IPv4', annotationEn: 'Layer 3 encapsulated protocol is IPv4' }
          ]
        },
        {
          ...
          fields: [
            ...
            { key: 'Differentiated Services Field', value: '0xc0 (DSCP: CS6, Precedence: Internetwork Control)', annotationAr: 'أولوية قصوى لحزم التحكم بالشبكة', annotationEn: 'Top priority class for network control traffic' },
            { key: 'Total Length', value: '68 bytes' },
            { key: 'Time to Live (TTL)', value: '1', annotationAr: 'قيمة الـ TTL هي 1 لمنع خروج حزمة Hello خارج الشبكة المحلية', annotationEn: 'TTL=1 restricts Hello packets to local subnet link' },
            { key: 'Protocol', value: 'OSPF (89)', annotationAr: 'رقم بروتوكول OSPF في ترويسة IP هو 89', annotationEn: 'OSPF protocol number in IPv4 header is 89' },
        ...
        },
        {
          ...
          fields: [
            ...
            { key: 'Source OSPF Router ID', value: '1.1.1.1', annotationAr: 'المعرف الفريد للراوتر في شبكة OSPF', annotationEn: 'Unique 32-bit Router-ID identifier' },
            { key: 'Area ID', value: '0.0.0.0 (Backbone Area 0)', annotationAr: 'المنطقة الرئيسية Area 0', annotationEn: 'Backbone Area 0 identifier' },
            { key: 'Checksum', value: '0x12b4 [correct]' },
            { key: 'Auth Type', value: 'Null (0)' },
            { key: 'Network Mask', value: '255.255.255.0 (/24)' },
            { key: 'Hello Interval', value: '10 seconds', annotationAr: 'يجب أن يتطابق مع الجار', annotationEn: 'Must match neighbor to establish adjacency' },
            { key: 'Router Dead Interval', value: '40 seconds (4x Hello)', annotationAr: 'مهلة إعلان موت الجار', annotationEn: 'Dead timer threshold before declaring neighbor down' },
            { key: 'Designated Router (DR)', value: '10.1.1.2', annotationAr: 'الراوتر المنتخب حالياً كـ DR', annotationEn: 'Currently elected Designated Router on segment' },
      ...
      layers: [
        ...
        },
        {
          ...
          fields: [
            ...
            { key: 'Type', value: '802.1Q Virtual LAN (0x8100)', annotationAr: 'يشير إلى وجود ترويسة Dot1Q Tag', annotationEn: 'Identifies presence of IEEE 802.1Q tag header' }
          ]
        },
        {
          layerName: '802.1Q Virtual LAN, PRI: 5, DEI: 0, ID: 10',
          fields: [
            { key: '101. .... .... .... = Priority (PCP / CoS)', value: '5 (Voice / Expedited Forwarding)', annotationAr: 'أولوية 5 لجودة الخدمة QoS', annotationEn: 'Priority 5 for Voice/Critical QoS handling' },
            { key: '...0 .... .... .... = Drop Eligible Indicator (DEI)', value: 'Ineligible (0)' },
            { key: '.... 0000 0000 1010 = VLAN Identifier (VID)', value: '10 (Engineering VLAN)', annotationAr: 'رقم الشبكة الوهمية المستهدفة هو 10', annotationEn: 'Target VLAN tag identifier is 10' },
            { key: 'Type', value: 'IPv4 (0x0800)', annotationAr: 'البروتوكول الداخلي المغلف', annotationEn: 'Inner encapsulated Layer 3 protocol' }
          ]
        },
        {
